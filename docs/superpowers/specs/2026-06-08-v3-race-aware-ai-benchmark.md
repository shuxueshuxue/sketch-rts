...
- Remaining stoplines: continue raising V3 from `87/100` to at least `90/100` on pgl; next investigation should focus on the remaining Grove combat-conversion losses plus Ember economy losses.
