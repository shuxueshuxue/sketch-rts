...
- Remaining stoplines: continue raising V3 from `84/100` to at least `90/100` on pgl; next investigation should focus on Grove combat-conversion losses plus the remaining Ember late-expansion/economy losses.
