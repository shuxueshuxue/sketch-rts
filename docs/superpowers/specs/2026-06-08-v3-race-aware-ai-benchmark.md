...
- Remaining stoplines: continue raising V3 from `76/100` to at least `90/100` on pgl; next investigation should focus on Ember's 35/50 lane and the remaining Grove-side combat-conversion losses.
