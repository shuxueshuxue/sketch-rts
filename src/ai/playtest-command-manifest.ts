...
export const AI_PLAYTEST_COMMAND_MANIFEST: AiPlaytestCommandSpec[] = [
  {
    ...
    requiredFlags: ["file"],
    optionalFlags: ["id", "map", "setup", "recipe", "from-benchmark", "benchmark-seed", "benchmark-map-count", "benchmark-full", "from-control-benchmark", "control-seed", "control-map-count", "control-worker-harassment", "control-full", "from-cross-race-benchmark", "cross-race-seed", "cross-race-map-count", "cross-race-full", "from-v3-vs-prod-v2-benchmark", "v3-prod-seed", "v3-prod-map-count", "v3-prod-full", "from-v4-tr-vs-v3-benchmark", "v4-tr-seed", "v4-tr-map-count", "v4-tr-full", "from-v5-vs-hybrid-benchmark", "v5-hybrid-seed", "v5-hybrid-map-count", "v5-hybrid-full", "from-gauntlet", "gauntlet-seed", "gauntlet-map-count", "gauntlet-full", "you", "enemy", "you-version", "enemy-version", "you-team", "enemy-team", "you-race", "enemy-race", "assist-you", "think-interval", "you-scripts", "enemy-scripts"],
