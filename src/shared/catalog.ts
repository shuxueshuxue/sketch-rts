...
export const UNIT_DEFS: Record<UnitKind, UnitDef> = {
  ...
  archer: { hp: 85, speed: 3, radius: 16, attackDamage: 22, attackRange: 570, attackCooldown: seconds(1.5), cost: 105, trainTime: seconds(7.75), supplyUsed: 2, xpReward: 30, abilities: [] },
  ...
  priest: { hp: 90, speed: 3, radius: 16, attackDamage: 11, attackRange: 360, attackCooldown: seconds(1.8), cost: 135, trainTime: seconds(9.25), supplyUsed: 2, xpReward: 35, abilities: ["heal"] },
  summoner: { hp: 95, speed: 2.8, radius: 17, attackDamage: 13, attackRange: 390, attackCooldown: seconds(1.9), cost: 150, trainTime: seconds(10.5), supplyUsed: 2, xpReward: 35, abilities: ["summon"] },
  witch: { hp: 92, speed: 3.1, radius: 16, attackDamage: 14, attackRange: 450, attackCooldown: seconds(1.7), cost: 145, trainTime: seconds(9.75), supplyUsed: 2, xpReward: 35, abilities: ["curse"] },
  ...
  contractArcher: { hp: 95, speed: 3.2, radius: 16, attackDamage: 31, attackRange: 630, attackCooldown: seconds(1.35), cost: 145, trainTime: seconds(0.05), supplyUsed: 2, xpReward: 34, abilities: [] },
  fieldMedic: { hp: 105, speed: 3.1, radius: 16, attackDamage: 13, attackRange: 375, attackCooldown: seconds(1.7), cost: 155, trainTime: seconds(0.05), supplyUsed: 2, xpReward: 36, abilities: ["heal"] },
...
export const BUILDING_DEFS: Record<BuildingKind, BuildingDef> = {
  ...
  defenseTower: { hp: 160, radius: 30, cost: 125, buildTime: seconds(6.5), trains: [], researches: [], attackDamage: 18, attackRange: 600, attackCooldown: seconds(1.5), supplyProvided: 0 },
