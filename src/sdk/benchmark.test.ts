          ...
          matches: [
            {
              ...
              agents: {
                v2: { controller: "external-agent" as const, team: "north", race: "grove" as const, versionLabel: "v2" },
                v1: { controller: "external-agent" as const, team: "south", race: "ember" as const, versionLabel: "v1" },
              },
              maxTicks: 0,
              thinkInterval: 45,
            },
