...
export const cavalryFlank = defineRecordingScene({
  name: "cavalry-flank",
  description: "Infantry lines engage; at 3 s Grove raiders and knights waiting behind the Ember line charge its archers.",
  createGame: () => {
    ...
    block(scene, "north", "raider", 6, { x: 2940, y: 2330, facing: "west", ranks: 2, spacingY: 46 });
    block(scene, "north", "knight", 2, { x: 3030, y: 2330, facing: "west", spacingY: 60 });
  ...
  defaults: { seconds: 14, camera: { type: "follow", zoom: 0.75 } },
});
